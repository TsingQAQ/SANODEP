...
def get_config():
    ...
    config.data.dataset_name = 'Brusselator'
    ...
    config.data.args.x_0_range =  ((0.1, 0.1), (2.0, 2.0))
    config.data.args.A_range = (0, 1) 
    config.data.args.B_range = (0.1, 3) 
    ...
    config.experimental_design.global_maximum_val = 2.1360953579344253
    config.experimental_design.ref_points = np.array([-1.46742833,  3.8866605])
