...
def get_config():
    ...
    config.model.name = 'PI_SANODEP_LV'
    ...
    config.model.cfg_args.latent_d_dim = 4
    ...
    config.model.cfg_args.param_clamping= partial(distance_penalized_term, 
                                                  ...
                                                  upper_bound = np.array([2.0, 3.0, 2.0, 2.0]))
    ...
    config.data.args.alpha_range = (1/3, 1.0)  # (1/3, 1/3) 
    config.data.args.beta_range = (1.0, 2.0)   #  (1.0, 1.0)
    config.data.args.delta_range = (0.5, 1.5)   # (0.5, 0.5)
    config.data.args.gamma_range = (0.5, 1.5)   # (0.5, 0.5)
