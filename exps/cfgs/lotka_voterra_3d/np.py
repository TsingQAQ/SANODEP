...
from NeuralProcesses.objectives import lotka_voterra_3d_observer, lotka_voterra_obj_func_3d
...
def get_config():
    ...
    config.data.dataset_name = 'LOTKA_VOLTERRA_ODE_3D'
    ...
    config.data.args.x_0_range =  ((0.1, 0.1, 0.1), (3.0, 3.0, 3.0))
    config.data.args.alpha_range = (1/3, 1) 
    config.data.args.beta_range = (1, 2) 
    config.data.args.delta_range = (0.5, 1.5) 
    config.data.args.gamma_range = (0.5, 1.5) 
    config.data.args.epsilon_range = (0.5, 1.5) 
    config.data.args.zeta_range = (0.5, 1.5) 
    config.data.args.eta_range = (0.5, 1.5) 
    config.data.args.theta_range = (0.5, 1.5) 
    config.data.args.generator = True
    config.data.args.time_scaling_coefficient = 10.0
    ...
    # intermediate visualization inspectation
    ...
    config.experimental_design.x0_lower_bound = np.asarray([0.1, 0.1, 0.1])
    config.experimental_design.x0_upper_bound = np.asarray([2.0, 2.0, 2.0])
    config.experimental_design.num_traj_iter = 10
    config.experimental_design.t0 = 0.0
    config.experimental_design.t1 = 1.5
    config.experimental_design.time_delay = 0.15001
    ...
    config.experimental_design.observer = partial(lotka_voterra_3d_observer, 
                                                  alpha_range = config.data.args.alpha_range, 
                                                  beta_range = config.data.args.beta_range, 
                                                  delta_range = config.data.args.delta_range, 
                                                  gamma_range = config.data.args.gamma_range, 
                                                  epsilon_range = config.data.args.epsilon_range,
                                                  zeta_range = config.data.args.zeta_range,
                                                  eta_range = config.data.args.eta_range,
                                                  theta_range = config.data.args.theta_range,)
    config.experimental_design.obj_func_form = lotka_voterra_obj_func_3d

    config.experimental_design.acq_mc_size = 32

    config.experimental_design.global_maximum_val = 41.3811616191294
    config.experimental_design.ref_points = np.array([-1.75566727, 13.16866714])
