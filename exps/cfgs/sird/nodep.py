...
def get_config():
    ...
    config.model.name = 'NeuralODEProcessAcceptMultiTimeSeriesData'
    ...
    config.model.cfg_args.r_to_zd_act_fn = "silu"
    ...
    config.data.foracsting_problem_prob = 0.0 # 1.0: always do forcasting problem, 0.0: always do regression problem 
    ...
    config.data.eval_metrics = {'MSE': 'NeuralODEProcessTestMSELossAcceptBatchData', 'NLL': 'NeuralODEProcessNLLLossAcceptBatchData'} 

    # loss
    config.loss_method = 'NeuralODEProcessMFVIMultiTrajectoryAwareLoss' 
