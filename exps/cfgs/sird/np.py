...
from NeuralProcesses.objectives import sird_obj_func, sird_observer
...
def get_config():
    ...
    config.model.name = 'NeuralProcessAcceptSystemData'
    
    # these are some args that will not be passed through setup
    config.model.sample_size = 1

    # model cfg args
    config.model.cfg_args = ml_collections.ConfigDict()
    
    config.model.cfg_args.x_dim =5
    config.model.cfg_args.y_dim = 4
    config.model.cfg_args.r_dim = 50
    config.model.cfg_args.z_dim = 55 # 50 # 50 
    config.model.cfg_args.encoder_h_dim = 50
    config.model.cfg_args.decoder_h_dim = 50
    config.model.cfg_args.variational_distribution_std_lower_bound = 1e-8
    config.model.sample_size = 1
    config.model.t0 = 0
    config.model.t1 = 1.0
    ...
    config.data.aux_eval_metric = {'MSE': 'NeuralProcessTestMSEAcceptDynamicSystemData', 'NLL': 'NeuralProcessTestNLLAcceptDynamicSystemData'} 
    ...
    config.data.args.beta_range = (0.5, 2.0)
    config.data.args.gamma_range = (0.1, 10.0) 
    config.data.args.mu_range = (0.1, 5.0) 
    config.data.args.generator = True
    config.data.args.time_scaling_coefficient = 1.0
    
    config.data.args.aux = {'MSE': (20, 100), 'NLL': (20, 100)} 
    config.data.eval_metrics = {'MSE': 'NeuralProcessTestMSEAcceptDynamicSystemData', 'NLL': 'NeuralProcessTestNLLAcceptDynamicSystemData'} 
    # loss
    config.loss_method = 'NeuralProcessMFVILossAcceptDynamicSystemData' 
