...
def get_config():
    ...
    config.model.name = "PI_SANODEP_SIR"
    ...
    config.model.cfg_args.latent_l_dim = 3
    ...
    config.data.args.beta_range = (0.1, 2.0) # (1.0, 1.0) # 
    config.data.args.gamma_range = (0.1, 10.0)  # (5.0, 5.0) # 
